...
if __name__=='__main__':
    print(find_library("AL_Miscellaneous"))
    print(find_library("Resistor_SMD"))
    ...
    #r2 = Module.from_library('stor_SMD', 'R_0805_2012Metric')
    #r1 = Module.from_library('Resistor_SMD', 'R_0805')
    #r3 = Module.from_library('Resistor_SMD', 'R_0805')
